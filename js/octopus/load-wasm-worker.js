...
// src/load-wasm-worker.ts: this file is concatenated at the end of the
// Emscripten-compiled unpack.cpp into jslib/load-wasm-worker.ts.
...
// function to pass the resulting asm.ts module when the decoded script is
...
function unpack(inBytes, callbackName) {
  ...
  if (!_asmjs_has_magic_number(packedPtr))
    throw "File does not appear to be packed asm.ts";
