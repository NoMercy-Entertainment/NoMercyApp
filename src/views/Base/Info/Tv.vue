    ...
    <ion-content ref="content" :fullscreen="true"
      ...
      <div
        ...
        <div
          ...
          <div
            ...
            <svg width="280" height="123" viewBox="0 0 280 123" fill="none" xmlns="http://www.w3.org/2000/svg"
              class="w-[280px] h-[122px] absolute left-0 top-[298px] blur-sm" preserveAspectRatio="none">
              ...
              <g filter="url(#filter1_bf_5719_22815)">
                <rect width="280" height="106" transform="matrix(1 0 0 -1 0 123)" fill="rgb(var(--color-focus))"
                  fill-opacity="0.05"></rect>
              </g>
              <g filter="url(#filter2_bf_5719_22815)">
                <rect width="280" height="90" transform="matrix(1 0 0 -1 0 123)" fill="rgb(var(--color-focus))"
                  fill-opacity="0.05"></rect>
              </g>
              <g filter="url(#filter3_bf_5719_22815)">
                <rect width="280" height="74" transform="matrix(1 0 0 -1 0 123)" fill="rgb(var(--color-focus))"
                  fill-opacity="0.05"></rect>
              </g>
              <g filter="url(#filter4_bf_5719_22815)">
                <rect width="280" height="58" transform="matrix(1 0 0 -1 0 123)" fill="rgb(var(--color-focus))"
                  fill-opacity="0.05"></rect>
              </g>
              <g filter="url(#filter5_bf_5719_22815)">
                <rect width="280" height="42" transform="matrix(1 0 0 -1 0 123)" fill="rgb(var(--color-focus))"
                  fill-opacity="0.05"></rect>
              </g>
              <defs>
                <filter id="filter0_bf_5719_22815" x="-1" y="0" width="282" height="124" filterUnits="userSpaceOnUse"
                  color-interpolation-filters="sRGB">
                  <feFlood flood-opacity="0" result="BackgroundImageFix"></feFlood>
                  <feGaussianBlur in="BackgroundImageFix" stdDeviation="0.5"></feGaussianBlur>
                  <feComposite in2="SourceAlpha" operator="in" result="effect1_backgroundBlur_5719_22815"></feComposite>
                  <feBlend mode="normal" in="SourceGraphic" in2="effect1_backgroundBlur_5719_22815" result="shape">
                  </feBlend>
                  <feGaussianBlur stdDeviation="0.5" result="effect2_foregroundBlur_5719_22815"></feGaussianBlur>
                </filter>
                <filter id="filter1_bf_5719_22815" x="-2" y="15" width="284" height="110" filterUnits="userSpaceOnUse"
                  color-interpolation-filters="sRGB">
                  <feFlood flood-opacity="0" result="BackgroundImageFix"></feFlood>
                  ...
                  <feGaussianBlur stdDeviation="1" result="effect2_foregroundBlur_5719_22815"></feGaussianBlur>
                </filter>
                <filter id="filter2_bf_5719_22815" x="-3" y="30" width="286" height="96" filterUnits="userSpaceOnUse"
                  color-interpolation-filters="sRGB">
                  <feFlood flood-opacity="0" result="BackgroundImageFix"></feFlood>
                  ...
                  <feGaussianBlur stdDeviation="1.5" result="effect2_foregroundBlur_5719_22815"></feGaussianBlur>
                </filter>
                <filter id="filter3_bf_5719_22815" x="-4" y="45" width="288" height="82" filterUnits="userSpaceOnUse"
                  color-interpolation-filters="sRGB">
                  <feFlood flood-opacity="0" result="BackgroundImageFix"></feFlood>
                  ...
                  <feGaussianBlur stdDeviation="2" result="effect2_foregroundBlur_5719_22815"></feGaussianBlur>
                </filter>
                <filter id="filter4_bf_5719_22815" x="-5" y="60" width="290" height="68" filterUnits="userSpaceOnUse"
                  color-interpolation-filters="sRGB">
                  <feFlood flood-opacity="0" result="BackgroundImageFix"></feFlood>
                  ...
                  <feGaussianBlur stdDeviation="2.5" result="effect2_foregroundBlur_5719_22815"></feGaussianBlur>
                </filter>
                <filter id="filter5_bf_5719_22815" x="-6" y="75" width="292" height="54" filterUnits="userSpaceOnUse"
                  color-interpolation-filters="sRGB">
                  <feFlood flood-opacity="0" result="BackgroundImageFix"></feFlood>
                  ...
                  <feGaussianBlur stdDeviation="3" result="effect2_foregroundBlur_5719_22815"></feGaussianBlur>
                </filter>
              </defs>
            </svg>
            ...
            <div class="flex justify-start items-start w-[280px] absolute left-0 top-[348px] gap-4 p-4">
              ...
              <button @click="trailerOpen = !trailerOpen"
        ...
        <div
          ...
          <p v-if="data?.title" class="self-stretch flex-grow-0 flex-shrink-0 w-[351px] text-4xl font-bold text-left">
            {{ data?.title ?? '&nbsp;' }}
          </p>
          <ion-skeleton-text v-else :animated="true" class="h-8 will-change-auto"></ion-skeleton-text>
          ...
          <div v-if="data?.overview"
            ...
            <div v-if="(data?.overview?.length ?? 0) > 170"
          ...
          <div class="self-stretch flex-grow-0 flex-shrink-0 h-px bg-[#e2f0fd]/[0.08]"></div>

          <div v-if="data?.year"
            class="flex justify-start items-center self-stretch flex-grow-0 flex-shrink-0 relative gap-2 h-8">

            <ContentRating v-if="data?.content_ratings" :size="8"
          ...
          <div v-if="data?.genres"
            ...
            <p class="flex-grow-0 flex-shrink-0 w-[120px] text-xs font-bold text-left text-[#9ba1a6]">
              {{ $t('Genres') }}
            </p>
            <div class="flex justify-start items-start flex-grow-0 flex-shrink-0 gap-1">
              <InfoItem :data="data" title="Genres" keyName="genres" prefix="genres" />
            </div>
          </div>
        ...
        <PersonCarousel v-if="data?.cast && data?.cast?.length > 0" :data="data?.cast" title="Cast" />
        ...
        <ImageCarousel v-if="data?.backdrops && data?.backdrops?.length > 0" :colorPalette="data?.color_palette?.poster"
          :data="data?.backdrops" title="Backdrop" type="backdrop" />
