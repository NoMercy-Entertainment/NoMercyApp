				...
				>
					...
					>
						...
						>
							...
							>
								<div
									class="relative flex w-full flex-grow flex-col items-start justify-start gap-4"
								>
									<div
									...
									>
										...
										<div
											class="mt-4 h-px self-stretch bg-white/10 sm:mt-0"
										/>
									</div>
									<div
										class="relative flex flex-col items-start justify-start self-stretch py-4 sm:gap-4"
									>
										<div
											class="flex w-full flex-col flex-wrap items-start gap-6 sm:flex-row sm:gap-2"
										>
											<div
											...
											>
												...
												<p
													class="w-full self-stretch whitespace-pre-wrap text-base font-medium"
												>
													{{ data?.place_of_birth }}
												</p>
											</div>
