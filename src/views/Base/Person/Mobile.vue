    ...
    >
      ...
      >
        <div
          ...
          <div
              class="absolute flex flex-col justify-start items-end flex-grow w-available -mx-20 h-[410px] bg-cover dark:bg-black/50"></div>
        </div>
        ...
        >
          ...
          <div
              class="flex flex-col gap-3 items-start flex-nowrap w-full"
          >
            ...
            >
              ...
              <HeaderItem v-if="data?.known_for_department" title="Known for"
              ...
              <HeaderItem v-if="age" title="Birthday">
                ...
                <p v-if="age"
                   class="text-left text-base font-medium text-contrast self-center whitespace-nowrap">{{
            ...
            >
              ...
              <HeaderItem v-if="gender"
                          title="Gender"
                          :data="gender"/>

              <HeaderItem v-if="data?.place_of_birth"
          ...
          <div
              class="self-stretch h-px bg-slate-dark-7/[0.1] dark:bg-slate-dark-11/[0.1]"></div>
