...
<template>
  <ion-page>
    <ion-content :fullscreen="true">
      ...
      <div class="w-[960px] h-[540px] absolute left-0 top-0 bg-[#131314] pointer-events-none -z-10" :key="data?.id"
      ...
      <ion-grid>
        <ion-row class="ion-align-items-end">
          ...
          <ion-col size="6" @focus="handleListFocus($event)" tabindex="0">
            <ScrollPanel
                class="w-available h-available scroll-smooth"
                :pt="{
                  barY: {
                    tabindex: -1,
                  },
                        ...
                        <ion-col size="8"
                          ...
                          <ion-label
                            ...
                            <div class="flex w-available overflow-clip items-end">
                              <div class="flex items-center justify-center h-full aspect-square overflow-clip transition-width duration-300"
                                   :class="{
