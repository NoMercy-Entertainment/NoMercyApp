...
<template>
	...
	<button :class="[
		active ? 'bg-[rgb(var(--color-focus,var(--color-theme-700))/80%)]' : 'text-auto-900',
		'group items-center flex gap-2 my-2 h-10 w-full notCurrentPage cursor-pointer rounded-md px-4 py-2 text-sm bg-auto-100',
	]" :onclick="onclick">
