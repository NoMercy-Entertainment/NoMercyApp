  ...
  <ion-page>
    <ion-content :fullscreen="true">
      <div :class="{
        ...
        <div v-if="greetingValue && musicSearchResult?.length == 0"
        ...
        <div
          ...
          <label class="flex w-available">
            <ion-input enterkeyhint="search" id="search" placeholder="Search for an Artist, Album or track..."
              ...
              :class="{
                '!py-2': !isOpen,
              }" v-model="musicSearchValue" name="search" type="search" ref="search" autocomplete="off" />
          </label>
        </div>
      </div>
