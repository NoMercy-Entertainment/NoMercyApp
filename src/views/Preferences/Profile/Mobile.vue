...
import {currentPlaylist} from "@/store/audioPlayer";
...
<template>
  <ion-page>
    <ion-content :fullscreen="true">
      <div class="flex flex-col gap-4 items-center justify-center px-4 h-available">
        <Select v-model="currentReceiver" :options="receivers" optionLabel="" class="w-full"/>
        ...
        <div v-if="playlistItem" class="flex flex-col gap-4 w-full items-center justify-center">
