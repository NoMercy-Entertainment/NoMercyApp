			...
			>
				...
				>
					<div class="mt-1 flex h-8">
						<div
							class="w-auto h-[7%] aspect-square absolute right-3 top-2 rounded-full bg-[#51525C] z-10"
						/>
						<div class="mt-1 flex items-center justify-start gap-4">
							<AppLogo class="z-10 mr-4 ml-1 w-20" />

							<div class="w-12 rounded-full h-1.5 bg-auto-12/60" />
							<div class="w-6 rounded-full h-1.5 bg-theme-8" />
							<div class="w-9 rounded-full h-1.5 bg-auto-11/20" />
						</div>
					</div>
					<div class="mt-2 flex w-full overflow-clip h-available">
						...
						>
							...
							>
								<div
									class="aspect-square h-auto w-3 rounded-full bg-auto-11/40"
								/>
								<div class="w-4/6 h-1.5 rounded-[8.48px] bg-auto-11/40" />
							</div>
							...
							>
								<div
									class="aspect-square h-auto w-3 rounded-full bg-auto-11/20"
								/>
								<div class="w-2/5 h-1.5 rounded-[8.48px] bg-auto-11/20" />
							</div>
							...
							>
								<div
									class="aspect-square h-auto w-3 rounded-full bg-auto-11/10"
								/>
								<div class="w-5/6 h-1.5 rounded-[8.48px] bg-auto-11/10" />
							</div>
						</div>

						<div class="relative w-px flex-1 rounded-lg mb-1.5">
							<div
								class="w-full h-full px-2 pt-2 gap-2.5 flex flex-col ml-auto overflow-hidden rounded-xl bg-slate-light-6 dark:bg-slate-dark-3 bg-cover border-2 border-transparent text-start transition-transform duration-200"
							>
								<div
									class="mx-auto h-24 w-full rounded-sm min-h-[5.5rem] bg-slate-light-11/90 dark:bg-slate-dark-1/90"
								/>
