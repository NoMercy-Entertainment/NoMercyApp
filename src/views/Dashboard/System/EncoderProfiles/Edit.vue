  ...
  >
    ...
    <div class="flex w-full flex-col" v-if="settings">
      <div class="flex w-full justify-between">
        ...
        <Button type="button" @click="addVideoProfile" id="addVideoProfile"
          >Add Video Profile</Button
        >
      </div>
      <template v-for="(profile, index) in videoCodecs" :key="index">
        <div
          class="m-2 mt-2 ml-0 flex w-full rounded-md border-white/5 p-4 border-1 odd:bg-auto-1/5 even:bg-auto-2/2"
        >
      ...
      <div class="flex w-full justify-between">
        ...
        <Button type="button" @click="addAudioProfile" id="addAudioProfile"
          >Add Audio Profile</Button
        >
      </div>
