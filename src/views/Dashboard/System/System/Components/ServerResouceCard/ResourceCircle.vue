...
const strokeDashoffset = computed(
	() =>
		(1 - (props.value === -1 ? 0 : props.value) / 100) * halfCircumference.value,
);
</script>

<template>
	<div
		class="relative flex aspect-video h-auto w-full flex-1 flex-shrink-0 flex-col items-start justify-center gap-1 flex-grow-1 text-surface-12/11"
	>
