          ...
          <thead
            ...
            <tr class="flex w-full flex-1 gap-4 text-xs font-medium bg-auto-2/10">
              ...
              <th
                ...
                <span>{{ $t('Type') }}</span>
                <LogTypeSelector v-if="logTypes" :logTypes="logTypes" v-model:selectedTypes="selectedTypes"
                  :refetch="refetch" />
              </th>
              <th
                class="relative flex h-11 items-center justify-between gap-3 self-stretch p-3 group/tableButton w-[120px] min-w-[120px]">
              ...
              <th
                ...
                <span>{{ $t('Message') }}</span>
                <InputText id="filter" v-model="filter" variant="filled" size="small" class="mr-auto ml-4 min-w-40"
