	...
	<IonPage>
		...
		<IonContent class="ion-padding">
			<div class="max-w-7xl mx-auto">
				<div class="mb-6">
					<h1 class="text-2xl font-bold text-auto-12 mb-2">
						Development Performance Dashboard
					</h1>
					<p class="text-auto-10">
				...
				<div class="mt-8 p-4 bg-auto-3 rounded-lg border border-auto-6">
					<h2 class="text-lg font-semibold text-auto-12 mb-3">
						Quick Actions
					</h2>
					<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
						<button
							...
							@click="handleReload"
						>
							<div class="font-medium text-auto-12">
								Reload Page
							</div>
							<div class="text-sm text-auto-10">
