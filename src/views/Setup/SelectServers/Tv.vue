    ...
    <ion-content :fullscreen="true">
      <div class="flex h-full w-full flex-auto flex-col items-center justify-center gap-8">
        <svg viewBox="0 0 814 806" fill="none"
          ...
          <g opacity="0.24">
            <mask id="mask0_2999_9934" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="-814" y="-822"
                  width="1628" height="1628">
          ...
          <defs>
            <radialGradient id="paint0_radial_2999_9934" cx="0" cy="0" r="1"
                            gradientUnits="userSpaceOnUse" gradientTransform="translate(0 -8) rotate(-90) scale(814)">
