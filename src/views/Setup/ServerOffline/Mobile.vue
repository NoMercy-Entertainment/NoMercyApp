...
const { data: playlists, refetch: refetchPlaylists } = useServerClient<
	Playlist[]
>({
	...
	<IonPage>
		<IonContent :fullscreen="true">
			<div class="flex flex-col justify-center items-center w-full h-full">
				...
				<h1
					class="text-4xl font-bold text-center text-slate-light-11 dark:text-slate-dark-11"
				>
					{{ $t("Server Offline") }}
				</h1>
			</div>
