...
import {BluRayPlaylist, DriveState} from "@/types/api/dashboard/ripper";

const rmOpen = ref(false);
export const ripperMenuOpen = computed(() => rmOpen.value);

export const setRipperMenuOpen = (value: boolean): void => {
    rmOpen.value = value;
...
export const toggleRipperMenuOpen = (): void => {
