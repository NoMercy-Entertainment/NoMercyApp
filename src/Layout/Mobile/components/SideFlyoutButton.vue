...
<template>
  <RouterLink v-if="href" :to="href" @click="onclick"
    ...
    <div class="w-1 flex-shrink-0 flex-grow-0 h-3.5"></div>
    <OptimizedIcon :icon="icon" className="relative h-6 w-6 flex-shrink-0 flex-grow-0" />
