...
<template>
	<div
		...
		class="relative flex flex-1 overflow-clip text-start outline-none transition-[color,border-color,margin] duration-200 h-available w-available scrollbar-none sm:rounded-3xl contain-strict"
		no-ring
		tabindex="-1"
	>
		<slot />
