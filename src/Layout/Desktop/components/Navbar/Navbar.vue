...
<template>
  ...
  <nav id="navbar"
    ...
    <button
        ...
        v-if="sidebar != 'hidden'"
        @click="toggleSidebar"
        class="ml-2 flex h-12 w-12 items-center justify-center rounded-md transition-transform duration-300 bg-auto-alpha-2 border-1 border-auto-alpha-5 text-auto-alpha-11 sm:hidden">
