...
<template>
  <div
    class="flex flex-1 h-[calc(100vh-6rem)] !min-h-[calc(100vh-6rem)] max-h-[calc(100vh-6rem)] music-showing:h-[calc(100vh-11rem)] music-showing:!min-h-[calc(100vh-11rem)] music-showing:max-h-[calc(100vh-11rem)] overflow-auto w-full flex-col scrollbar-none group/scrollContainer pb-2"
