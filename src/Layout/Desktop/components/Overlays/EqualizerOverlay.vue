...
import {equalizerMenuOpen} from '@/store/audioPlayer';

import EqualizerPanel from "@/components/MusicPlayer/components/EqualizerPannel.vue";

</script>

<template>
  <div :data-open="equalizerMenuOpen" :inert="!equalizerMenuOpen"
