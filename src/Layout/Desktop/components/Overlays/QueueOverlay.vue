		...
		>
			<div class="flex w-full items-center justify-between p-2 pr-6">
				...
				>
					...
					<OptimizedIcon :icon="MoooomIcons.shareSquare" class-name="w-4 h-4" />
				</RouterLink>
			</div>
			...
			>
				...
				<div class="relative flex flex-col items-start justify-start gap-1">
					<p
						class="w-full flex-shrink-0 font-semibold self-stretch-0 text-left"
					>
						{{ currentSong?.name }}
					</p>
					<div
						...
						<div class="-ml-1 w-available" data-marquee="container">
							...
							>
								...
								>
									...
									>
										<span
											class="flex items-center gap-1 leading-none line-clamp-2"
										>
				...
				<ScrollContainer :auto-hide="true" :static="false">
					<template v-for="song in queue" :key="song?.id">
						...
						>
							...
							<div
								class="relative flex flex-col items-start justify-start gap-1"
							>
								<p
									class="w-full flex-shrink-0 font-semibold self-stretch-0 text-left"
								>
