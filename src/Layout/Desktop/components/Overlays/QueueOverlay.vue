...
<template>
  <div :data-open="queueMenuOpen"
       class="absolute right-4 top-4 bottom-8 sm:bottom-4 overflow-clip w-available ml-4 sm:w-1/3 bg-slate-light-3 dark:bg-slate-dark-1 flex items-center justify-center rounded-lg transition-all duration-300 border-2 border-focus data-[open='false']:translate-x-[150%] z-[9999]">
    <div
