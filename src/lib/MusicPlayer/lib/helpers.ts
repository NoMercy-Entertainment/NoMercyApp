...
import {
    ...
    TimeState, Volume, IsRepeating, IsPlaying, EQSliderValues, EQBand, EqualizerPreset,
} from './types';
...
export class Helpers extends EventTarget {
    ...
    equalizerBands: EQBand[] = [
        {frequency: 'Pre',  gain: this.equalizerSliderValues.pre.default },
        {frequency: 70,     gain: this.equalizerSliderValues.band.default},
        {frequency: 180,    gain: this.equalizerSliderValues.band.default},
        {frequency: 320,    gain: this.equalizerSliderValues.band.default},
        {frequency: 600,    gain: this.equalizerSliderValues.band.default},
        {frequency: 1000,   gain: this.equalizerSliderValues.band.default},
        {frequency: 3000,   gain: this.equalizerSliderValues.band.default},
        {frequency: 6000,   gain: this.equalizerSliderValues.band.default},
        {frequency: 12000,  gain: this.equalizerSliderValues.band.default},
        {frequency: 14000,  gain: this.equalizerSliderValues.band.default},
        {frequency: 16000,  gain: this.equalizerSliderValues.band.default},
    ]
