...
import { useSocket } from '@/lib/clients/socketClient/index';

export const connect = (socket: HubConnection) => {

//     setSocket(toRaw(socket));
//     // @ts-ignore
...
export const onConnect = (socket: HubConnection) => {
...
export const onDisconnect = (socket: HubConnection) => {
