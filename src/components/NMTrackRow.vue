...
<template>
  ...
  >
        <span class="flex w-10 h-10 justify-center text-center min-w-10 relative">
            ...
            <CoverImage v-if="isMusicSearchRoute"
                        :data="data"
                        :size="100"
    ...
    <span class="flex sm:h-12 items-center gap-4 overflow-hidden w-available">
            ...
            <span class="flex h-full flex-col justify-center overflow-clip w-inherit items-start">
                ...
                <span class="flex h-6 leading-3 flex-nowrap overflow-clip text-left font-bold line-clamp-1 w-inherit items-center">
                    {{ data.name }}
                </span>
...
<!--       </span>-->
<!--    </template>-->
    <span class="hidden sm:flex items-center justify-between gap-2 text-end"
          @click="e => e.stopPropagation()">
