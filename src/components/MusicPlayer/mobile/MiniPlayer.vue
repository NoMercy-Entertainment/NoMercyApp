...
<template>
  ...
  >
    ...
    <div class="flex flex-grow items-center justify-start gap-2.5">
      ...
      <div class="relative flex h-full flex-grow flex-col items-start justify-evenly"
           ref="target"
        ...
        <p class="children:children:children:children:children:leading-6 w-auto self-stretch text-left text-sm text-auto-12/11">
