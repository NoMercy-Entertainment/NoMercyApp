...
<template>
    <RouterLink v-if="data?.type !== 'playlists'" :to="data?.link" :style="`
            --color-focus: ${ringColor};
          `" class="relative flex flex-grow items-center justify-start gap-4 overflow-clip rounded-2xl p-1.5 group/musicCard
          bg-gradient-to-b from-[#021c37]/[0.08] to-[#05294d]/[0.03] dark:from-[#e2f0fd]/[0.08] dark:to-[#d5feff]/[0.03]
...
">
        ...
        <div class="relative flex flex-shrink-0 flex-grow-0 flex-col items-start justify-center gap-2">
            ...
            <div class="relative flex flex-shrink-0 flex-grow-0 items-center justify-start gap-1">
    ...
    <RouterLink v-else-if="data?.type == 'playlists'" :to="data?.link" :style="`--color-focus: ${ringColor}`"
        ...
        <div class="relative flex w-28 flex-grow-0 items-center justify-start gap-2 rounded-xl flex-shrink-0-0">
            <MusicCardImage :data="data" />
        </div>
        <div class="relative flex flex-shrink-0 flex-grow-0 flex-col items-start justify-center gap-2">
