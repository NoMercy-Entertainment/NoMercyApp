...
<template>
	...
	>
		...
		>
			<p class="flex-shrink-0 flex-grow-0 text-2xl font-bold">
				{{ $t("Most listened") }}
			...
			>
				<p class="flex-shrink-0 flex-grow-0 text-base font-medium">
					{{ data?.name }}
				</p>
			</div>
		</div>
	...
	>
		...
		<div
			class="relative flex flex-shrink-0 flex-grow-0 flex-col items-start justify-center gap-2"
		>
			<p class="flex-shrink-0 flex-grow-0 text-2xl font-semibold">
				{{ $t("Most listened") }}
				{{ data?.type?.replace(/s$/u, "")?.toTitleCase() }}
			</p>
			<div
				class="relative flex flex-shrink-0 flex-grow-0 items-center justify-start gap-1"
			>
				<p class="flex-shrink-0 flex-grow-0 text-base">
					{{ data?.name }}
				</p>
			</div>
		</div>
