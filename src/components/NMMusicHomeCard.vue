...
<template>
	...
	>
		...
		>
			<p
				class="flex-shrink-0 flex-grow-0 text-2xl font-semibold text-auto-12 line-clamp-1 overflow-clip w-available"
			>
				{{ $t("Most listened") }}
			...
			>
				<p
					class="flex-shrink-0 flex-grow-0 text-base text-auto-12 line-clamp-1"
				>
					{{ data?.name }}
				</p>
			</div>
