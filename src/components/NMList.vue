...
<template>
  <div v-if="items"
       class="mt-4 mb-2 sm:mr-8 sm:mr-0 flex flex-1 flex-col w-auto flex-shrink-0 flex-grow-1 items-start justify-start gap-2 self-stretch will-change-auto text-left"
  >
