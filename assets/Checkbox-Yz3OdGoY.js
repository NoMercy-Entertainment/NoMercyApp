import{J as l,S as a,T as o,Z as u,c as f,j as p,kt as x,w as k,x as s}from"./i18n-Cs-AFcrY.js";f();var w=["id","checked"],y=["id","height","width"],g=["innerHTML"],m={key:0,class:"relative flex flex-grow items-center justify-center gap-2 px-2"},v={class:"w-full flex-grow text-sm font-medium"},_=p({__name:"Checkbox",props:{id:{type:String,required:!1},modelValue:{type:Boolean,required:!1,default:null},label:{type:String,required:!1},width:{type:String,required:!1,default:"18"},height:{type:String,required:!1,default:"18"},color:{type:String,required:!1,default:"hsl(from var(--color-theme-8) h s 20%)"},onclick:{type:Function,required:!1}},emits:["update:modelValue"],setup(t,{emit:n}){const e=t,d=n;function c(){if(e.onclick){e.onclick?.();return}let r;e.modelValue===null||e.modelValue===!1?r=!0:e.modelValue===!0&&(r=!1),d("update:modelValue",r)}const i=s(()=>`
      <defs>
    ...
    `:`
      ...
      ${i.value}
    `);return(r,V)=>(l(),o("div",{class:"relative flex select-none items-center justify-start gap-2 self-stretch border border-transparent bg-transparent",onClick:c},[a("input",{id:t.id,checked:!!t.modelValue,class:"hidden item-selector",type:"checkbox"},null,8,w),(l(),o("svg",{id:t.id,height:t.height,width:t.width,class:"relative w-[18px] h-[18px]",fill:"none",preserveAspectRatio:"xMidYMid meet",viewBox:"0 0 18 18",xmlns:"http://www.w3.org/2000/svg"},[a("g",{innerHTML:h.value},null,8,g)],8,y)),t.label?(l(),o("div",m,[a("p",v,x(r.$t(t.label)),1)])):k("",!0),u(r.$slots,"default")]))}}),F=_;export{F as t};
