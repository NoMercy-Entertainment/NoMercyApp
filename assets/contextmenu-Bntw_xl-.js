import{As as c,Fs as B,Is as y,Jo as A,Ms as G,Ns as E,Ps as g,Ss as d,Us as M,Ws as N,Yo as D,cs as b,ls as f,oc as U,os as C,ps as S,rc as w,rs as Y,ss as v,ts as L}from"./index-khqYokjz.js";import{C as V,F as j,M as q,Q as x,T as p,W as Z,Y as H,b as W,f as F,h as T,lt as k,n as X,nt as J,ot as Q,t as z,ut as $}from"./basecomponent-BJUjlmgZ.js";import{i as ee}from"./button-D9MH9LKC.js";import{t as te}from"./baseicon-eZ1fqFF5.js";function ne(){let t=[],e=(a,u,m=999)=>{let s=r(a,u,m),l=s.value+(s.key===a?0:m)+1;return t.push({key:a,value:l}),l},n=a=>{t=t.filter(u=>u.value!==a)},o=(a,u)=>r(a,u).value,r=(a,u,m=0)=>[...t].reverse().find(s=>u?!0:s.key===a)||{key:a,value:m},i=a=>a&&parseInt(a.style.zIndex,10)||0;return{get:i,set:(a,u,m)=>{u&&(u.style.zIndex=String(e(a,!0,m)))},clear:a=>{a&&(n(i(a)),a.style.zIndex="")},getCurrent:a=>o(a,!0)}}var P=ne();A();var _={name:"Portal",props:{appendTo:{type:[String,Object],default:"body"},disabled:{type:Boolean,default:!1}},data:function(){return{mounted:!1}},mounted:function(){this.mounted=Q()},computed:{inline:function(){return this.disabled||this.appendTo==="self"}}};function ie(t,e,n,o,r,i){return i.inline?E(t.$slots,"default",{key:0}):r.mounted?(c(),v(Y,{key:1,to:n.appendTo},[E(t.$slots,"default")],8,["to"])):b("",!0)}_.render=ie;var oe=`
    .p-contextmenu {
