import{$s as c,Ac as B,As as b,Dc as M,Es as G,Gs as d,Is as E,Ms as f,_s as A,ac as y,ic as N,js as v,ks as C,mc as j,nc as S,pc as w,rc as g,tc as U,vs as T,ws as L}from"./index-H5TKJIZK.js";import{C as V,F as q,M as Y,Q as x,T as p,W as Z,Y as H,b as W,f as F,h as D,lt as k,n as X,nt as J,ot as Q,t as z,ut as $}from"./basecomponent-uOIwYz8E.js";import{i as ee}from"./button-DxFCaLIt.js";import{t as te}from"./baseicon-Bb-M_KCx.js";function ne(){let t=[],e=(a,u,m=999)=>{let s=r(a,u,m),l=s.value+(s.key===a?0:m)+1;return t.push({key:a,value:l}),l},n=a=>{t=t.filter(u=>u.value!==a)},o=(a,u)=>r(a,u).value,r=(a,u,m=0)=>[...t].reverse().find(s=>u?!0:s.key===a)||{key:a,value:m},i=a=>a&&parseInt(a.style.zIndex,10)||0;return{get:i,set:(a,u,m)=>{u&&(u.style.zIndex=String(e(a,!0,m)))},clear:a=>{a&&(n(i(a)),a.style.zIndex="")},getCurrent:a=>o(a,!0)}}var P=ne();A();var _={name:"Portal",props:{appendTo:{type:[String,Object],default:"body"},disabled:{type:Boolean,default:!1}},data:function(){return{mounted:!1}},mounted:function(){this.mounted=Q()},computed:{inline:function(){return this.disabled||this.appendTo==="self"}}};function ie(t,e,n,o,r,i){return i.inline?S(t.$slots,"default",{key:0}):r.mounted?(c(),b(G,{key:1,to:n.appendTo},[S(t.$slots,"default")],8,["to"])):v("",!0)}_.render=ie;var oe=`
    .p-contextmenu {
