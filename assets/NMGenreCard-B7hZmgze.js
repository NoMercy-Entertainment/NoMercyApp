import{$ as g,At as o,C as p,Dt as _,S as e,Y as u,c as m,j as x,k as v,lt as b,x as l}from"./i18n-DBb78QAI.js";import"./ionic-DNKsarlx.js";import"./vue-core-C9HAaO_1.js";import{Hi as f,b as h}from"./index-A9ZXfM_l.js";m();var k={class:"relative flex flex-shrink-0 flex-grow-0 flex-col items-center justify-center h-[75%]"},w={class:"relative flex flex-shrink-0 flex-grow-0 flex-col items-start justify-center self-stretch px-4 pb-0 text-theme-12/12"},y={class:"flex-shrink-0 flex-grow-0 self-stretch text-sm font-semibold w-available line-clamp-1"},C={class:"flex-shrink-0 flex-grow-0 self-stretch text-xs opacity-60 w-available"},j=x({__name:"NMGenreCard",props:{data:{type:Object,required:!0},index:{type:Number,required:!1,default:0},contextMenuItems:{type:Array,required:!1,default:()=>[]}},setup(r){const t=r,n=l(()=>`scroll_${t.data?.titleSort?.[0]?.toUpperCase?.()}`),i=l(()=>({0:"group-hover/card:rotate-[-4deg] group-hover/card:scale-[1.1]",1:"group-hover/card:rotate-[4deg] group-hover/card:scale-[1.1]"})[t.index%2]),a=l(()=>f(t.data.title));return(d,s)=>{const c=g("RouterLink");return u(),p(c,{class:_(`flex flex-col relative justify-start items-center w-full h-auto aspect-poster flex-grow flex-shrink-0 overflow-hidden rounded-lg border-1-light transition-all duration-200 select-none group/card ${a.value.bg} bg-theme-6 hover:bg-theme-8 dark:bg-theme-5 dark:hover:bg-theme-7 hover:shadow-[0px_0px_0_3px_var(--color-theme-9)]`),"data-scroll":n.value,to:r.data.link,style:{}},{default:b(()=>[s[0]||(s[0]=e("div",{class:"backdropCard-overlay"},null,-1)),e("div",k,[e("div",{class:_(`flex items-center justify-center w-auto h-auto aspect-square p-4 object-cover rounded-3xl overflow-clip transition-all duration-200 ${i.value} ${a.value.iconBg}
          ...
          rounded-3xl
            ...
            rgb(from var(--color-theme-7) r g b / 20%))`,"background-blend-mode":"normal, overlay, normal"}},[v(h,{icon:a.value.icon,"class-name":"w-20"},null,8,["icon"])],2)]),e("div",w,[e("p",y,o(d.$t(r.data.title)),1),e("p",C,o(r.data.have_items)+" "+o(r.data.have_items>1?"items":"item"),1)])]),_:1},8,["class","data-scroll","to"])}}}),B=j;export{B as default};
